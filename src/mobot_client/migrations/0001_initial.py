...
import mobot_client.models.messages
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('error', models.TextField(blank=True, help_text='An error, if it exists', null=True)),
                ('successful', models.BooleanField(default=True)),
                ('payment', models.OneToOneField(help_text='The raw payment receipt', on_delete=django.db.models.deletion.CASCADE, to='mobot_client.signalpayment')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('txo_id', models.CharField(max_length=255)),
                ('direction', models.SmallIntegerField(choices=[(0, 'received_from_customer'), (1, 'sent_to_customer')], default=1, verbose_name=mobot_client.models.messages.Direction)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('incoming', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responses', to='mobot_client.message')),
                ('payment', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='response_payment', to='mobot_client.payment')),
                ('response', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='response_message', to='mobot_client.message')),
            ],
        ),
        migrations.AddField(
            model_name='message',
            name='payment',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobot_client.payment'),
        ),
        migrations.AddField(
            model_name='message',
            name='raw',

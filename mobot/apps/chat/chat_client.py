...
class Mobot:
    ...
    def _handle_chat(self, message: SignalMessage):
        ...
        with context:
            ...
            for handler in self.handlers:
                # First, check for explicit text that has been filtered to match the handler's regex
    ...
    def register_default_handlers(self):
        ...
        # DETAIL:  Failing row contains (46, 2021-07-18 21:20:48.916259+00, 2021-07-18 21:20:48.916278+00, null, 0, , +15555555555).

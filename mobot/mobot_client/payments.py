...
class Payments:
    ...
    def __init__(self, mobilecoin_client, minimum_fee_pmob, account_id, store, messenger, signal):
    ...
    def send_mob_to_customer(self, source, amount_mob, cover_transaction_fee):
        ...
        if customer_payments_address is None:
            self.signal.send_message(source,
        ...
        self.send_mob_to_address(source, self.account_id, amount_mob, customer_payments_address)

    def send_mob_to_address(self, source, account_id, amount_in_mob, customer_payments_address):
        ...
        tx_proposal = self.mcc.build_transaction(account_id, amount_in_mob, customer_payments_address)
        ...
        for _ in range(10):
            ...
            self.signal.send_message(source, "couldn't generate a receipt, please contact us if you didn't a payment!")
            return
    ...
    def handle_item_payment(self, source, customer, amount_paid_mob, drop_session):
        ...
        if mc.mob2pmob(amount_paid_mob) > mc.mob2pmob(item_cost_mob) + self.minimum_fee_pmob:
